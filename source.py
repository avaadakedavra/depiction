# -*- coding: utf-8 -*-
"""N_CapGANs_v7(Capsules).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10wPiel0SVsho3ppFujcwCtvi75YstkHW
"""
...
def main():
    ...
    for j in range(3):
      generated_image = gan.generate_image_from_text(text)
      generated_image.save(current_dir + '/data/test/' + Capsules.model_name + '-generated-' + str(i) + '-' + str(j) + '.jpg')
